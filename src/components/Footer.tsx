        ...
        <>
            <section className='container'>
                <div className='bg-bd-green rounded-3xl p-4 md:p-6 lg:p-8 text-center'>
                    ...
                    <Link className='btn-secondary mt-2' href={'#lavoriamo-insieme'} title='Lavoriamo insieme'>Lavoriamo insieme <ArrowRight /></Link>
                </div>
            </section>


            <section className='container pt-10 md:pt-16 lg:pt-20' id='lavoriamo-insieme'>
                <div className='bg-gray-100 rounded-3xl p-4 md:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12'>
                    <div className='overflow-hidden'>
                        ...
                        <p className='mt-4 m-0'>O forse preferisci contattarmi per <Link className='font-bold underline' href={'#contatti'} title='Vai a contatti'>telefono, e-mail o WhatsApp</Link>?</p>
                    </div>
            ...
            <footer className='container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 pt-10 md:pt-16 lg:pt-20 pb-6 md:pb-8 lg:pb-10'>
                <div className='lg:col-span-2' id='contatti'>
                    ...
                    <h2 className='sr-only'>Come contattarmi</h2>
                    <ul>
                        <li>
