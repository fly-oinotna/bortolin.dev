...
const ToolTip: React.FC<ToolTipProps> = ({ children, text }) => {
    ...
    return (
        <span
            className='relative cursor-pointer inline-flex items-start underline underline-offset-4'
        ...
        >
            ...
            {visible && (
                <span className='absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-52 p-3 text-xs text-white bg-black rounded-lg shadow-lg'>
                    {text}
                </span>
            )}
        </span>
