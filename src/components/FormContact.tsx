        ...
        <form className='p-4' onSubmit={handleSubmit}>
            <fieldset className='grid grid-cols-1 lg:grid-cols-2 gap-y-4 gap-x-6 lg:gap-x-8'>
                ...
                <div>
                    ...
                    <input className='block w-full p-2 rounded-lg border border-gray-200' type="text" id="name" name="name" required value={name} onChange={(e) => setName(e.target.value)} />
                </div>
                <div>
                    <label className='block text-xs text-gray-600 pb-1' htmlFor="email">Indirizzo e-mail</label>
                    <input className='block w-full p-2 rounded-lg border border-gray-200' type="email" id="email" name="email" required value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
